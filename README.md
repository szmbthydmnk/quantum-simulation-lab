...
[![Lines of Code](https://img.shields.io/badge/lines%20of%20code-<!-- LOC-AUTO-START -->5112<!-- LOC-AUTO-END -->-lightgrey)](#)
...
| v0.3 | TEBD / iTEBD scaffolding | 🔲 Planned |
| v0.4 | DMRG building blocks cleanup | 🔲 Planned |
| v1.0 | Stable public API | 🔲 Planned |
| v1.5 | AQA, QML, QEC interfaces | 🔲 Planned |

See [`ROADMAP.md`](./ROADMAP.md) for detailed per-version task lists.
